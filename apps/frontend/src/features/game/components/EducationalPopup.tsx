  ...
  return createPortal(
    ...
    >
      <div
        ...
        tabIndex={-1}
        className="w-full max-w-lg max-h-[85vh] overflow-y-auto space-y-5 rounded-lg border border-emerald-300/30 bg-slate-900 p-6 shadow-2xl shadow-slate-950/50 animate-sos-fade-slide"
      >
