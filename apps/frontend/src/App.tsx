...
function RouteFallback() {
  return (
    <div className="py-16 text-center text-sm text-sos-muted" role="status" aria-live="polite">
      불러오는 중...
    </div>
  )
}
      ...
      <header className="border-b border-white/10 bg-slate-950/90">
        <nav className="mx-auto flex w-full max-w-6xl items-center justify-between px-5 py-4">
          <Link
            ...
            className="text-glow-emerald rounded-sm text-lg font-bold tracking-normal text-sos-strong transition hover:text-emerald-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-200 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
          >
            Safe or Scam
          </Link>
          <div className="flex items-center gap-4 text-sm text-sos-body">
            {isAuthenticated ? (
              <>
                <Link
                  to="/lobby"
                  className="rounded-sm transition hover:text-sos-strong focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-200 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
                >
                  로비
                </Link>
                <Link
                ...
                <button
                  ...
                  className="rounded-md border border-white/10 px-3 py-1.5 text-slate-200 transition hover:border-emerald-300 hover:text-sos-strong focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-200 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 disabled:cursor-not-allowed disabled:text-sos-faint"
                >
        ...
        >
          ...
          <div className="flex justify-end gap-2">
            <button
              ...
              className="rounded-md border border-white/10 px-3 py-1.5 text-xs font-semibold text-sos-body hover:border-emerald-300 hover:text-sos-strong"
            >
              닫기
            </button>
            <button
